...
const BookSingle = ({ books }) => {
  return (
    <div className='border-2 border-gray-500 rounded-1g px-4 py-2 m-4 relative hover:shadow-x1' >
        ...
        <div className="flex justify-start items-center gap-x-2">
          <PiBookOpenTextLight className="text-r ed-300 text-2xl" />
